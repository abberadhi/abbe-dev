    ...
    <article className="px-12 bg-transparent mx-auto lg:px-8">
      ...
      <div className="max-w-4xl my-12 mx-auto flex flex-col md:items-start align-center justify-center md:flex-row">
        ...
        <div className="text-lg flex-1 flex mt-4 md:mt-0">
          <p>
            I’m Abbas Radhi (or &quot;Abbe&quot;), a developer from Sweden with
            a degree in Software Development and over two years of experience.
            I’ve worked on both frontend and backend development and enjoy
            solving problems and learning new things. I’m always eager to grow
